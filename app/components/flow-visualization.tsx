...
import { FlowVisualizationProps } from "../interface/flow-visualization.interface"
  ...
  return (
    <div className="space-y-6 p-6 bg-card rounded-lg border border-border overflow-hidden">
      <div className="flex items-center justify-between gap-2">
        <div
          className={`flex-1 p-4 rounded-lg bg-gradient-to-r from-slate-600 to-slate-700 text-white text-center font-semibold transition-all duration-300 ${active ? "shadow-lg shadow-slate-600/50 scale-105" : ""
            }`}
        >
        ...
        <div
          className={`w-12 h-1 bg-gradient-to-r from-slate-600 to-primary transition-all duration-300 ${active ? "shadow-lg shadow-primary/50" : ""
            }`}
        ></div>

        <div
          className={`flex-1 p-4 rounded-lg bg-gradient-to-r ${getMethodColor(
            method
          )} text-white text-center font-semibold transition-all duration-300 ${active ? "shadow-lg shadow-primary/50 scale-105" : ""
            }`}
        >
        ...
        <div
          className={`w-12 h-1 bg-gradient-to-r from-primary to-accent transition-all duration-300 ${active ? "shadow-lg shadow-accent/50" : ""
            }`}
        ></div>

        <div
          className={`flex-1 p-4 rounded-lg bg-gradient-to-r from-purple-600 to-purple-700 text-white text-center font-semibold transition-all duration-300 ${active ? "shadow-lg shadow-purple-600/50 scale-105" : ""
            }`}
        >
